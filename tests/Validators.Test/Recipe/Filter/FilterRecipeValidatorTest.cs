...
public class FilterRecipeValidatorTest
{
    ...
    public void Error_Invalid_Cooking_Time()
    {
        ...
        result.Errors.ShouldSatisfyAllConditions(
            ...
            errors => errors.Single().ErrorMessage.ShouldBe(ResourceMessagesException.COOKING_TIME_NOT_SUPPORTED));
    }
    ...
    public void Error_Invalid_Difficulty()
    {
        ...
        result.Errors.ShouldSatisfyAllConditions(
            errors => errors.ShouldHaveSingleItem(),
            errors => errors.Single().ErrorMessage.ShouldBe(ResourceMessagesException.DIFFICULTY_LEVEL_NOT_SUPPORTED));
    }
    ...
    public void Error_Invalid_DishTypes()
    {
        ...
        result.Errors.ShouldSatisfyAllConditions(
            errors => errors.ShouldHaveSingleItem(),
            errors => errors.Single().ErrorMessage.ShouldBe(ResourceMessagesException.DISH_TYPE_NOT_SUPPORTED));
    }
}